...
const roleColors = {
  USER: 'light-info',
  DEALER: 'light-danger',
  MANUFACTURER: 'light-warning',
  DISTRIBUTOR: 'light-success',
  APPROVERS: 'light-primary'
}
            ...
            <div className='d-flex align-items-center flex-column'>
              ...
              <div className='d-flex flex-column align-items-center text-center'>
                <div className='user-info'>
                  <h4>{selectedUser !== null ? selectedUser?.name?.toUpperCase() : 'Eleanor Aguilar'}</h4>
                  {selectedUser !== null ? (
            ...
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                ...
                <li className='mb-75'>
                  ...
                  <Badge className='text-capitalize' color={statusColors[selectedUser.approved === true ? 'active' : 'inactive']}>
                    {selectedUser.approved === true ? 'Approved' : 'Pending'}
                  </Badge>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Subscription Blocked Status:</span>
                  <Badge className='text-capitalize' color={statusColors[selectedUser.isBlocked === true ? 'active' : 'inactive']}>
                    {selectedUser.isBlocked === true ? 'Subscription Blocked' : 'Subscription Active'}
                  </Badge>
                </li>
                <li className='mb-75'>
